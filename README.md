...
https://github.com/vnpycn/vntrader

VNTrader是VNPY官方推出的一款国内期货量化交易开源软件， 基于MIT开源协议，任何机构和个人可以免费下载和使用，无需付费。
VNTrader计划继承VNPY官方开源库，也就是计划将VNPY仿真回测系统集成在VNPY中使用。

抛弃历史上出现的大杂烩版本，价格全新升级，性能提供382%。

全新版本的VNPY官方推出的 VNTrader 是专门面向国内合规市场，面向商品期货、股指期货实现程序化交易CTP接口的专属版本，符合“精简、高性能、精细化回测、功能强大、入门更容易”等特点。
...
采用“大资金，小杠杆”的思路去做交易才是职业化投资者的体现，对自有资金有限的情况下，募集资金就显的非常重要了。

募集资金一定不能脱离中国的金融环境，所以一定要在国家认定合规的市场里进行。

身边一个最真实的例子，有一个程序员，从2015年偶然受人之托开发一个CTP抢单程序而接触到CTP接口， 后面半年他在CTP研发上投入大量时间，到了2016年他接触到了投资人，投资人让他管理了4000万资金，到了2018年又发展到了1亿规模。 这些资金是别人投资给他的，他不用承担风险 ，利润和投资人五五分，通过CTP接口程序化交易，他的年化收益也做到了50%。

他的业绩通过期货保证金中心证明，很快期货公司又找上门，又为他发了几千万的产品。

所以说：走正确的道，事半功倍；走错误的道，事倍功半。
...
（1）成交机制不同，模拟账户采用对手价成交，实盘在盘中撮合成交。
...
通过比较，可以得出结论，B方案比A方案收益更好，方案更合理。

我们以B方案基础，再增加一个交易条件，产生B1方案、B2方案、B3方案......,如此再做一次资金曲线的对比回测，获得最优方案。
如此循环往复若干次后，就可以得到一个非常合理完美的策略。

但通常需要同时对多个不同走势的品种做量化交易策略的验证。

这种研发策略的方式相比仅仅靠参数优化的方式是更加容易开发出优秀量化交易策略的。
 
 该大类趋势策略，通过30组子方案得测试优化，获得效果最好得7个子策略资金曲线如下，可完美用于实盘
 ![VNPYlogo](http://www.vnpy.cn/f7.png?t=0)
